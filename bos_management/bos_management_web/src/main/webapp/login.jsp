            ...
            <div class="col-md-4 col-md-offset-7 logincontent">
                ...
                <form class="form-horizontal" id="loginform" name="loginform" method="post"
                    ...
                    <div class="form-group" id="idInputLine">
                        ...
                        <div class="col-sm-8">
                            <input id="loginform:idInput" type="text" name="username" class="form-control"
                    ...
                    <div class="form-group" id="pwdInputLine">
                        ...
                        <div class="col-sm-8">
                            <input name="password" for="pwdInput" type="password" class="form-control" id="inputaccount"
                                   placeholder="请输入您的密码">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input name="validateCode" type="text" class="form-control" id="inputaccount"
                                   placeholder="请输入验证码">
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="col-md-offset-3 col-md-8">
                        <a href="javascript:document.getElementById('loginform').submit();" id="loginform:j_id19"
