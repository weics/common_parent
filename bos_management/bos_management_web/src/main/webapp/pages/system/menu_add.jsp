...
<div data-options="region:'center'">
    <form id="menuForm" method="post" action="${pageContext.request.contextPath}/menuAction_save.action">
            ...
            <tr>
                ...
                <td>
                    <input name="parentMenu.id" class="easyui-combotree"
                           data-options="url:'${pageContext.request.contextPath}/menuAction_listajax.action'"/>
                </td>
            </tr>
            <tr>
                <td>描述</td>
